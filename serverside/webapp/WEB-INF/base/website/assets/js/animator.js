document.addEventListener("DOMContentLoaded", function () {
  ...
  scatters.forEach((scatter) => {
    var posX = getRandomBetween(100, window.innerWidth - 300);
    var posY = getRandomBetween(100, window.innerHeight - 100);
    scatter.style.left = posX + "px";
    scatter.style.top = posY + "px";
  });
  var imageCoords = {
    0: [-655, -345],
    1: [725, -55],
  ...
  var introTl = gsap.timeline({ delay: 17 });
  ...
  introTl.to("#animation-container", {
    delay: 3,
    duration: 1,
    scaleY: 0,
    transformOrigin: "top",
    ease: "expo.in",
    onComplete: function () {
      document.querySelector("#animation-container").remove();
      AOS.init({
        duration: 600,
        once: true,
      });
